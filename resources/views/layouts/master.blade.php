...
* { margin: 0; padding: 0; }
		...
		body { 
			background: url("{{ asset('assets/sam20.png')}}") no-repeat center center fixed; 
...
<nav class="navbar navbar-default" style="border:0px;background: transparent;
  ">
        <div class="container">
          ...
          <a href="{{ route('welcome')}}"><img src="{{ asset('img/logos/ncsw.png') }}" class="nav-img" />
                    </a>
          ...
          {{--  @if(isset(Auth::user()->id) && Auth::user()->hasAnyPermission(['All','Edit Portal','View Portal']))--}}
            <li class="" style="width: 140px;"><a class="{{ Request::segment(1) === 'home' ? 'active' : null }} {{ Request::segment(1) === 'genderStatistics' ? 'active' : null }} { Request::segment(1) === 'indicators' ? 'active' : null }}" style="font-size:13px" href="{{ route('home')}}">Gender Statistics </a></li>
            {{--   @endif--}}
            
            @if(Request::segment(1) != "knowledgehub")
            @if(isset(Auth::user()->id) && Auth::user()->hasAnyPermission(['All','Add / Edit / Delete Data','View Data']))
              <li class="" style="width: 140px;"><a class="{{ Request::segment(1) === 'knowledgehub' ? 'active' : null }} {{ Request::segment(1) === 'knowledgehubdetail' ? 'active' : null }}" style="font-size:13px" href="{{url('knowledgehub')}}">Knowledge Hub </a></li>
              @else
        ...
        @endif
            ...
            @if(isset(Auth::user()->id) && Auth::user()->hasAnyPermission(['All','Add / Edit / Delete Data','View Data']))
              <li style="width: 140px;"><a style="font-size:13px" class="{{ Request::segment(1) === 'knowledgehubdetail' ? 'active' : null }}{{ Request::segment(1) === 'knowledgehub' ? 'active' : null }}"  href="{{url('knowledgehub')}}">Knowledge Hub</a></li>
...
{{--
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="font-size: 12px;"> {{ Auth::user()->name}} <span class="caret"></span></a>
