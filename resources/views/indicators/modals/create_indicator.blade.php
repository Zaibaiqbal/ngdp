                ...
                <!-- <i class="fa fa-plus modal-check-pro"></i> -->
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-12" style="margin-top:5px;">
                       ...
                       <input class="form-control" type="text" name="data_requirement">
                     </div>

<div class="col-md-12">
<button id="add_field_button" class="pull-right btn-xs btn-primary" style="">Add More</button></div>
                     <div class="col-md-12" id="mynewdiv">
                       <div class="row">
                      <div class="col-md-12">
                        <label class="pull-left">Select SDG<span style="color:red">*</span></label>
                        <select class="form-control" required name="sdg[]" id="sdg_id_1" onchange="sdgchange('1')">
                      ...
                      <div class="col-md-12">
                        ...
                        <select class="form-control" required name="target[]" id="targets_1" onchange="targetchange('1')">
                          <option value="0">Please Select SDG Target</option>
                        </select>
                      </div>
                      <div class="col-md-12">
                        <label class="pull-left">Select SDG Indicator<span style="color:red">*</span></label>
                        <select class="form-control" required name="indicator[]" id="indicators_1">
                      ...
                      <div class="col-md-12">
                        <label class="pull-left">Select Beijing + 25</label>
