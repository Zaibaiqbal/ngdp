...
<div class="row" style="margin-bottom:200px;">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0 text-dark">{{$knowladge_hub_list->count()}}</span>
                </div>
                <div class="col-auto">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0 text-dark">{{$law_and_regulation_list->count()}}</span>
                </div>
                <div class="col-auto">
                  <div class="icon icon-shape text-dark rounded-circle shadow">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0 text-dark">{{$article_list->count()}}</span>
                </div>
                <div class="col-auto">
                  <div class="icon icon-shape text-dark rounded-circle shadow">
                    <img style="width: 100%;
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0 text-dark">{{$data_set_list->count()}}</span>
                </div>
                <div class="col-auto">
                  <div class="icon icon-shape text-dark rounded-circle shadow">
                    <img style="width: 100%;
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="card card-stats mb-4 mb-xl-0" style="background-image: linear-gradient(to right, #c39de0 , #9898CC);">
                ...
                <div class="row">
                    ...
                    <span class="h2 font-weight-bold mb-0 text-dark">{{$infographic_list->count()}}</span>
                    </div>
                    <div class="col-auto">
                    <div class="icon icon-shape text-dark rounded-circle shadow">
                        <img style="width: 100%;
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="card-body">
                ...
                <div class="col">
                    ...
                    <span class="h2 font-weight-bold mb-0 text-dark">{{$training_knowledge_list->count()}}</span>
                </div>
                <div class="col-auto">
                    <div class="icon icon-shape text-dark rounded-circle shadow">
                    <img style="width: 100%;
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="card card-stats mb-4 mb-xl-0" style="background-image: linear-gradient(to right, #c39de0 , #9898CC);">
                ...
                <div class="row">
                    ...
                    <span class="h2 font-weight-bold mb-0 text-dark">{{$booklets_knowledge_list->count()}}</span>
                    </div>
                    <div class="col-auto">
                    <div class="icon icon-shape text-dark rounded-circle shadow">
                        <img style="width: 100%;
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="card-body">
                    ...
                    <div class="col">
                        ...
                        <span class="h2 font-weight-bold mb-0 text-dark">{{$pamphlets_knowledge_list->count() + $posters_knowledge_list->count()}}</span>
                    </div>
                    <div class="col-auto">
                        <div class="icon icon-shape text-dark rounded-circle shadow">
                        <img style="width: 100%;
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="margin-right:3%; margin-top:10px;height:1250px;background-image: linear-gradient(to right, #c39de0 , #9898CC);border-radius:2%">
            ...
            <ul class="nav nav-tabs" style="margin-top: 20px;display:inline-grid">
                ...
                <li class="theme_list theme_list_active @if($knowledge_theme->id == $theme->id) active @endif " value="{{encrypt($theme->id)}}" onclick="showMultipleThemeData(event,this)" >
