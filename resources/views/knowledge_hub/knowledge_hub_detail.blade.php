...
<div class="welcome-adminpro-area">
    <!-- CONTAINER -->
    <div class="container" style="background-color: #b6c0cc;opacity:0.9;border-radius: 17px;margin-bottom:15%;">
        <!-- ROW -->
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" >
                            <table class="table table-striped">
                                ...
                                @if($knowladge['institution'] != null)
                                <tr>
                                <th>Organization/Institution</th>
                                <td>{{$knowladge['institution']}}</td>
                                </tr>
                                @endif

                                @if($knowladge['new_year'] != null)
                                <tr>
                                <th>Year</th>
                                <td>{{$knowladge['new_year']}}</td>
                                </tr>
                                @endif
                            </table>
                        </div>
