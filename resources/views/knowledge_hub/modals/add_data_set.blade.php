@php($uniqid = uniqid())
<!-- REPORTS MODALS  -->
 <div id="md_add_data_set" class="modal modal-adminpro-general default-popup-PrimaryModal fadeIn" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form id="form_add_data_set" enctype="multipart/form-data" method="Post" action="{{route('store.data_set')}}">
          @csrf
            <div class="modal-header header-color-modal" style="background-color: #BCA0D8;">
                <h4 class="modal-title" style="display: inline-flex;">Add Data Sets</h4>
...
--}}
            ...
            <input type="hidden" name="tagname" value="tab3"></input>
            <div class="modal-footer">
              <button class="btn btn-primary"  data-dismiss="modal">Close</button>
                <button class="btn btn-info" onclick="storeDataset(event,this);">Submit</button>
            </div>
            </form>
        </div>
    </div>
