@php($uniqid = uniqid())
<!-- REPORTS MODALS  -->
 <div id="md_add_other" class="modal modal-adminpro-general default-popup-PrimaryModal fadeIn" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form id="form_add_other" enctype="multipart/form-data" method="Post" action="{{route('store.otherknowledge')}}">
          @csrf
            <div class="modal-header header-color-modal" style="background-color: #BCA0D8;">
                <h4 class="modal-title" style="display: inline-flex;">Add Other</h4>
            ...
            <div class="modal-body" style="margin: 30px; padding:0; text-align: left !important;">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                     ...
                     <input type="hidden" name="tagname" value="tab5"></input>
                </div>
            </div>
            <div class="modal-footer">
              <button class="btn btn-primary"  data-dismiss="modal">Close</button>
                <button class="btn btn-info" onclick="storeOtherKnowledge(event,this);">Submit</button>
            </div>
            </form>
        </div>
    </div>
