@php($uniqid = uniqid())
<!-- REPORTS MODALS  -->
 <div id="md_add_infographics" class="modal modal-adminpro-general default-popup-PrimaryModal fadeIn" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form id="form_add_infographics" enctype="multipart/form-data" method="Post" action="{{route('store.infographic')}}">
          @csrf
            <div class="modal-header header-color-modal" style="background-color: #BCA0D8;">
                <h4 class="modal-title" style="display: inline-flex;">Add Infographics</h4>
...
--}}
                   @php($name  = 'source')
                    ...
                    <input type="hidden" name="tagname" value="tab4"></input>
            <div class="modal-footer">
              <button class="btn btn-primary"  data-dismiss="modal">Close</button>
                <button class="btn btn-info" onclick="storeInfographics(event,this);">Submit</button>
            </div>
            </form>
        </div>
    </div>
