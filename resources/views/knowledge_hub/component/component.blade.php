...
<div class="col-lg-12">
    <!-- <ul class="nav nav-tabs custom-menu-wrap">
        <li class="active" id="act1"><a data-toggle="tab" href="#tab1">Reports and Books <span class="badge badge-primary"><small>{{@count($knowladge_list)}}</small></span></a>
        </li>

        <li id="act6"><a data-toggle="tab" href="#tab6">Laws and Regulations <span class="badge badge-primary"><small>{{@count($law_regulation_list)}}</small></span> </a>
        </li>

        <li id="act2"><a data-toggle="tab" href="#tab2">Articles and Perspectives <span class="badge badge-primary"><small>{{@count($article_list)}}</small></span></a>
        </li>
        <li id="act3"><a data-toggle="tab" href="#tab3">Data Sets <span class="badge badge-primary"> <small>{{@count($data_set_list)}}</small></span></a>
        </li>
        <li id="act4"><a data-toggle="tab" href="#tab4">Infographics <span class="badge badge-primary"><small>{{@count($info_graphics_list)}}</small></span> </a>
        </li>

          <li id="act5"><a data-toggle="tab" href="#tab5">Others <span class="badge badge-primary"><small>{{@count($other_knowledge_list)}}</small></span> </a>
        </li>
    ...
    <div class="panel-heading accordion-head">
        <h4 class="panel-title">
            <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab1" style="color:black;">Reports and Books ({{$knowladge_list->count()}})</a>
        </h4>
    </div>
  </div>
  </div>
      ...
      <div id="tab1" class="panel-collapse panel-ic collapse in ">
          <div class="panel-body admin-panel-content animated bounce">
              	...
              	<b>	Showing results {{@count($knowladge_list)}} of {{@count($knowladge_list)}}</b>
              	...
              	@foreach($knowladge_list as $rows)
              	<!-- IMAGE PART -->
            ...
            @if($knowladge_list instanceof \Illuminate\Pagination\LengthAwarePaginator)
            <div class="col-sm-12">
              <div class="pull-right">
                {{$knowladge_list->links()}}
              </div>
            </div>
            @endisset
        ...
        <div class="panel-heading accordion-head">
            <h4 class="panel-title">
                  <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab6" style="color:black;">Laws and Regulations ({{$law_regulation_list->count()}})</a>
            </h4>
        </div>
        </div>
        </div>
        ...
        <div id="tab6" class="panel-collapse panel-ic collapse">
            ...
            <div class="row" style="padding: 10px;">
                ...
                <div class="col-sm-12">
                   <b> Showing results {{@count($law_regulation_list)}} of {{@count($law_regulation_list)}}</b>
                    @if(isset(Auth::user()->id) && Auth::user()->hasAnyPermission(['All','Add / Edit / Delete Data']) )
                ...
                @foreach($law_regulation_list as $rows)
                ...
                @if($law_regulation_list instanceof \Illuminate\Pagination\LengthAwarePaginator)
                <div class="col-sm-12">
                  <div class="pull-right">
                    {{$law_regulation_list->links()}}
                  </div>
                </div>
                @endisset
            ...
            <h4 class="panel-title">
                  <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab2" style="color:black;">Articles and Perspectives ({{$article_list->count()}})</a>
                    ...
                    <div id="tab3" class="panel-collapse panel-ic collapse">
                        ...
                        <div class="panel-heading accordion-head">
                            <h4 class="panel-title">
                              <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab4" style="color:black;">Infographics ({{$info_graphics_list->count()}})</a>
                            </h4>
                        </div>
                        </div>
                        </div>
                                    ...
                                    @php($image_list = ['info1.jpg','info2.jpg','info3.jpg','info4.png'])
                                          ...
                                          <div class="row" style="padding: 10px;">
                                             <div class="col-sm-12">
                                             <b> Showing results {{@count($info_graphics_list)}} of {{@count($info_graphics_list)}}</b>
                                            ...
                                            @foreach($info_graphics_list as $rows)
                                            {{--
                                            <div class="col-md-3">
                                              <div class="thumbnail">
                                        ...
                                        <!-- ENDdata TEXT PART -->
                                            @endforeach
                                            @if($info_graphics_list instanceof \Illuminate\Pagination\LengthAwarePaginator)
                                            <div class="col-sm-12">
                                              <div class="pull-right">
                                                {{$info_graphics_list->links()}}
                                              </div>
                                            </div>
                                            @endisset
                                ...
                                <div class="panel-heading accordion-head">
                                    <h4 class="panel-title">
                                      <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab5" style="color:black;">Trainings ({{$other_knowledge_list->where('type',"Training Material")->count()}})</a>
                                    </h4>
                                </div>
                                </div>
                                </div>
...
<div class="col-sm-12"><hr></div>
                                                    ...
                                                    <div class="col-sm-12" style="word-wrap: break-word;">
                                                       ...
                                                       <div class="tab-content custom-menu-content">
                                                            ...
                                                            <div class="row" style="padding: 10px; border:1px sold #000;">
                                                              ...
                                                              @foreach($other_knowledge_list->where('type',"Training Material") as $rows)
                                                              <div class="col-sm-12" style="word-wrap: break-word;">
                                        ...
                                        <div class="panel-heading accordion-head">
                                            <h4 class="panel-title">
                                              <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab7" style="color:black;">Booklets ({{$other_knowledge_list->where('type',"Booklets")->count()}})</a>
...
<div class="col-sm-12"><hr></div>
                                                            <div class="col-sm-12" style="word-wrap: break-word;">
                                                               ...
                                                               <div class="tab-content custom-menu-content">
                                                                    ...
                                                                    <div class="row" style="padding: 10px; border:1px sold #000;">
                                                                      ...
                                                                      @foreach($other_knowledge_list->where('type',"Booklets") as $rows)
                                                                      <div class="col-sm-12" style="word-wrap: break-word;">
                                                ...
                                                <div class="panel-heading accordion-head">
                                                    <h4 class="panel-title">
                                                      <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab8" style="color:black;">Pamphlets ({{$other_knowledge_list->where('type',"Pamphlets")->count()}})</a>
...
<div class="col-sm-12"><hr></div>
                                                                    <div class="col-sm-12">
                                                                      ...
                                                                      <div class="row" style="padding: 10px; border:1px sold #000;">
                                                                              ...
                                                                              @foreach($other_knowledge_list->where('type',"Pamphlets") as $rows)
                                                                              <div class="col-sm-12" style="word-wrap: break-word;">
                                                        ...
                                                        <div class="panel-heading accordion-head">
                                                            <h4 class="panel-title">
                                                                <a data-toggle="collapse" class="" data-parent="#accordion" href="#tab9" style="color:black;">Posters ({{$other_knowledge_list->where('type',"Posters / Leaflets")->count()}})</a>
                                                            </h4>
                                                        </div>
                                                        </div>
                                                        </div>
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                               ...
                                                                               <div class="tab-content custom-menu-content">
                                                                                <div class="row" style="padding: 10px; border:1px sold #000;">
                                                                                      ...
                                                                                      @foreach($other_knowledge_list->where('type',"Posters / Leaflets") as $rows)
                                                                                      <div class="col-sm-12">
