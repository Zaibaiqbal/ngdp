...
<div class="container-fluid">
	...
	@foreach($sub_theme_indicator1 as $rows)
		<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12" >
			<div class="card" style="background-color: white;">
				...
				<h1 class="indicator-title" id="indicator-title1_{{$loop->iteration}}" style="font-size:40px;display:inline-flex"><a href="#"></a></h1>&nbsp;<span><small style="font-weight:bold;font-size:15px" id="indicator-unit_{{$loop->iteration}}"></small></span>

				<h1 class="card-title" style="font-size:44px;display:inline-flex" id="title1_{{$loop->iteration}}"></h1> <small style="font-weight:bold;font-size:15px" id="unit1_{{$loop->iteration}}"></small>
				...
				<div id="chartContainer1_{{$loop->iteration}}" style="height: 250px; width: 100%;"></div>
			</div>
		</div>
		@endforeach
	...
	<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12" >
			<div class="card" style="background-color: white;">
				...
				<div class="card-body">
				<input type="hidden" id="map_indicator" name="indicator" value="{{encrypt($rows->id)}}">
				...
				<h1 class="card-title map-indicator-title " id="indicator-title" style="font-size:44px;display:inline-flex" ></h1> <small style="font-weight:bold;font-size:15px" id="map-indicator-unit"></small>
					...
					<a style="font-weight:bolder;margin-top:1%;font-size:13px;" target="_blank" href="https://unwomenutydgwevcwe772.the-estatech.com/map/index.html?{{$curr_theme->id}}&{{$rows->id}}&{{$rows->current_year}}&{{$rows->data_source_name}}">More Details...</a>
			
				</div>
				<img src="{{asset('assets/maps/'.$rows->id.'.png')}}" width="100%" height="50%" style="" alt="">
	...
	@foreach($sub_theme_indicator2 as $rows)
		<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12" >
			<div class="card" style="background-color: white;">
				...
				<h1 class="indicator-title" id="indicator-title2_{{$loop->iteration}}" style="font-size:40px;display:inline-flex"><a href="#"></a></h1>&nbsp;<span><small style="font-weight:bold;font-size:15px" id="indicator-unit_{{$loop->iteration}}"></small></span>

				<h1 class="card-title" style="font-size:44px;display:inline-flex" id="title2_{{$loop->iteration}}"></h1> <small style="font-weight:bold;font-size:15px" id="unit2_{{$loop->iteration}}"></small>
				...
				<div id="chartContainer2_{{$loop->iteration}}" style="height: 250px; width: 100%;"></div>
			</div>
		</div>
		@endforeach
	...
	<div class="col-md-4 col-lg-4 col-sm-12 col-xs-12" >
			<div class="card" style="background-color: white;">
				...
				<h1 class="card-title map-indicator-title " id="indicator-title" style="font-size:44px;display:inline-flex" ></h1> <small style="font-weight:bold;font-size:15px" id="map-indicator-unit"></small>
					...
					<p class="card-text">
					<a href="{{route('indicators',['id' => encrypt($map_indicator2->id)])}}" style="margin-top:-20px !important;color:purple !important">
						<b>
						{{$map_indicator2->data_requirement}}
						</b>
					</a>
					...
					<a style="font-weight:bolder;margin-top:1%;font-size:13px;" target="_blank" href="https://unwomenutydgwevcwe772.the-estatech.com/map/index.html?{{$curr_theme->id}}&{{$map_indicator2->id}}&{{$map_indicator2->current_year}}&{{$map_indicator2->data_source_name}}">More Details...</a>
			
				</div>
				<img src="{{asset('assets/maps/'.$map_indicator2->id.'.png')}}" width="100%" height="50%" style="" alt="">
...
var route = "{{url('indicatorgraphview')}}";
    ...
    $.post(route,data_set,function(data){
		...
		if(data.national_info['unit'] == "Number"){
			...
			$("#title1_"+count).html(data.national_info['current_value']);
			...
			$("#title1_"+count).html(data.national_info['current_value']);
			$("#unit1_"+count).html(data.national_info['unit']);
...
var route = "{{url('indicatorgraphview')}}";
    ...
    $.post(route,data_set,function(data){
		...
		if(data.national_info['unit'] == "Number"){
			...
			$("#title2_"+count).html(data.national_info['current_value']);
			...
			$("#title2_"+count).html(data.national_info['current_value']);
			$("#unit2_"+count).html(data.national_info['unit']);
...
function getIndividualIndicatorGraph1(data,count){
	...
	var chart = new CanvasJS.Chart("chartContainer1_"+count, {
	// exportEnabled: true,
...
var chart = new CanvasJS.Chart("chartContainer2_"+count, {
// exportEnabled: true,
animationEnabled: true,
title:{
	text: ""
