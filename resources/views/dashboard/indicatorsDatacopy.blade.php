...
@endif
    ...
    <div class="col-md-12" style="margin-top:10px;">
      <button class="btn btn-success" onclick="searchchilds()">Search</button>
    </div>
    <div class="col-md-12" style="margin-top:10px;">
      <button class="btn btn-danger" onclick="filterindicatorchild()">Reset</button>
    </div>
  ...
  <div class="col-md-8" id="childdata" style="margin-bottom:100px;">
